...
/obj/item/clothing/accessory/pandora_hope/on_uniform_equip(obj/item/clothing/cloth, user)
	var/mob/living/L = user
	if(L && L.mind)
		SEND_SIGNAL(L, COMSIG_ADD_MOOD_EVENT, "hope_lavaland", /datum/mood_event/hope_lavaland)

/obj/item/clothing/accessory/pandora_hope/on_uniform_dropped(obj/item/clothing/cloth, user)
	var/mob/living/L = user
	if(L && L.mind)
