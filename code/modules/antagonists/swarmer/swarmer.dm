...
// BLUEMOON ADD - у воина нет способностей, кроме репликации
/mob/living/simple_animal/hostile/swarmer/warrior/Initialize(mapload)
	...
	remove_verb(src, /mob/living/simple_animal/hostile/swarmer/proc/RepairSelf)
	remove_verb(src, /mob/living/simple_animal/hostile/swarmer/proc/ToggleLight)
