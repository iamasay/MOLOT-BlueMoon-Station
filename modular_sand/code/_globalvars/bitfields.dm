...
DEFINE_BITFIELD(interaction_flags, list(
	...
	"INTERACTION_FLAG_RANGED_CONSENT" = INTERACTION_FLAG_RANGED_CONSENT,
	"INTERACTION_FLAG_UNHOLY_HARD" = INTERACTION_FLAG_UNHOLY_HARD,
))
...
DEFINE_BITFIELD(required_from_user, list(
	...
	"INTERACTION_REQUIRE_TAIL" = INTERACTION_REQUIRE_TAIL,
	"INTERACTION_REQUIRE_KNOT" = INTERACTION_REQUIRE_KNOT,
	"INTERACTION_REQUIRE_DOUBLE_PENIS" = INTERACTION_REQUIRE_DOUBLE_PENIS,
	"INTERACTION_REQUIRE_TK" = INTERACTION_REQUIRE_TK,
))
