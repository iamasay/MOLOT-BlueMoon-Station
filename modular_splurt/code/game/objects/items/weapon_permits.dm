...
/obj/item/clothing/accessory/permit/special/c_02
	...
	permitted_weapons = "Любое неконтробандное оружие, снаряжение зелёного уровня контрабанды, а так же автоматические винтовки, пистолеты и револьверы высокого калибра, не имеющие символики InteQ "
