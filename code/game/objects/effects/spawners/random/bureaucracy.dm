/obj/effect/spawner/lootdrop/random/bureaucracy
	...
	icon = 'modular_bluemoon/icons/misc/random_spawners.dmi'
...
/obj/effect/spawner/lootdrop/random/bureaucracy/stamp
	name = "stamp spawner"
	icon_state = "stamp"
	loot = list(
		/obj/item/stamp = 3,
...
/obj/effect/spawner/lootdrop/random/bureaucracy/crayon
	name = "crayon spawner"
	icon_state = "crayon"
	loot = list(
...
/obj/effect/spawner/lootdrop/random/bureaucracy/paper
	name = "paper spawner"
	icon_state = "paper"
	loot = list(
		/obj/item/paper = 20,
...
/obj/effect/spawner/lootdrop/random/bureaucracy/briefcase
...
/obj/effect/spawner/lootdrop/random/bureaucracy/folder
	name = "folder spawner"
	icon_state = "folder"
	loot = list(
