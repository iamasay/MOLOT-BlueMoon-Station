...
#define RAD_DEFAULT_ROBOT_SAFE 750					// Like above, except for robotic carbons.
#define RAD_UPGRADED_ROBOT_SAFE 1250				// If the robot has been upgraded via an implant, their radiation threshold is increased.
