...
/obj/item/clothing/suit/cbrn/mopp/advance
	...
	armor = list(MELEE = 45, BULLET = 25, LASER = 50, ENERGY = 50, BOMB = 40, BIO = 100, RAD = 50, FIRE = 100, ACID = 100, WOUND = 30) //Scale with standard MOPP suits as this effects all ERT suits
