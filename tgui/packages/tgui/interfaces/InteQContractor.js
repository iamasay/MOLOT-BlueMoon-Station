...
export const InteQContractorContent = (props, context) => {
  ...
  const terminalMessages = [
    ...
    "Analyzing embedded inteq info...",
    "STATUS CONFIRMED",
    "Contacting inteq database...",
    "Awaiting response...",
    "Awaiting response...",
    "Awaiting response...",
    "Awaiting response...",
  ...
  const infoEntries = [
    ...
    "regular InteQ uplink to purchase whatever you may need.",
      ...
      <Grid>
        <Grid.Column size={0.85}>
          <LabeledList>
            ...
            <LabeledList.Item label="CR Earned">
              {data.earned_tc}
            </LabeledList.Item>
          </LabeledList>
        </Grid.Column>
