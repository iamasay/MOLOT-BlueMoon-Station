...
#define STORAGE_VOLUME_BAG_OF_HOLDING				(DEFAULT_VOLUME_NORMAL * 12) //BLUEMOON CHANGE, WAS 20
#define STORAGE_VOLUME_BAG_OF_HOLDING_DEBUG			(DEFAULT_VOLUME_NORMAL * 30) //BLUEMOON EDIT
#define STORAGE_VOLUME_CHEMISTRY_BAG				(DEFAULT_VOLUME_TINY * 50)
#define STORAGE_VOLUME_PILL_BOTTLE					(DEFAULT_VOLUME_TINY * 7)

// max_volume для MOD storage modules
#define STORAGE_VOLUME_MOD_DEFAULT 					(DEFAULT_VOLUME_NORMAL * 5)
#define STORAGE_VOLUME_MOD_EXTENDED 				STORAGE_VOLUME_BACKPACK
#define STORAGE_VOLUME_MOD_BLUESPACE 				STORAGE_VOLUME_DUFFLEBAG
#define STORAGE_VOLUME_MOD_UPLINK_UPDATER 			STORAGE_VOLUME_BAG_OF_HOLDING
