...
///Bridge pipes under plating: still above the pipe they cross, still below wires.
#define HIGH_PIPE_HIDDEN_LAYER 2.36
...
#define FLOOR_LIGHTING_LAMPS_PLANE 5
#define FLOOR_LIGHTING_LAMPS_RENDER_TARGET "*FLOOR_LIGHTING_LAMPS_RENDER_TARGET"
#define FLOOR_LIGHTING_LAMPS_SELFGLOW 6
#define FLOOR_LIGHTING_LAMPS_GLARE 7
#define LIGHTING_LAMPS_PLANE 8
#define LIGHTING_LAMPS_RENDER_TARGET "*LIGHTING_LAMPS_RENDER_TARGET"
#define LIGHTING_LAMPS_SELFGLOW 9
#define LIGHTING_EXPOSURE_PLANE 10
#define LIGHTING_LAMPS_GLARE 11
