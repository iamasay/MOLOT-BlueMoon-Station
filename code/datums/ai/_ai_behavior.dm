// PORT: tgstation@14140a6355d1 code/datums/ai/_ai_behavior.dm
// Контракт perform(): вернуть флаги AI_BEHAVIOR_DELAY/SUCCEEDED/FAILED/INSTANT;
// finish_action по флагам зовёт контроллер (ProcessBehavior), не само поведение.
...
///Returns a set of flags defined in [code/__DEFINES/ai.dm]
