...
/obj/item/storage/garment_case/engineering_chief/PopulateContents()
	...
	new /obj/item/clothing/suit/toggle/labcoat/depjacket/eng/chief_engineer(src)
...
/obj/item/storage/garment_case/hos/PopulateContents() // Я не знаю почему тут было закоменченно, но факт того что отдел был пустой заставил меня плакать.
	...
	new /obj/item/clothing/under/rank/security/officer/blueshirt/seccorp/sheriff(src)
	new /obj/item/clothing/head/HoS(src)
	new /obj/item/clothing/head/warden/campaignhat(src)
...
/obj/item/storage/garment_case/warden/PopulateContents()
	...
	new /obj/item/clothing/under/rank/security/officer/blueshirt/seccorp/undersheriff(src)
