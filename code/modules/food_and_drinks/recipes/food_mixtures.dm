...
/datum/chemical_reaction/food
	...
	var/container_transform = FALSE // transforming one thing in another

/datum/chemical_reaction/food/on_reaction(datum/reagents/holder, multiplier)
	...
	if(container_transform)
		...
		qdel(holder.my_atom)
	else for(var/i in 1 to multiplier)
		new resulting_food_path(location)
...
/datum/chemical_reaction/food/hot_coco
	name = "Hot Coco"
...
/datum/chemical_reaction/food/cheesewheel
	...
	required_catalysts = list(/datum/reagent/consumable/enzyme = 5)
	resulting_food_path = /obj/item/reagent_containers/food/snacks/store/cheesewheel
	mob_react = FALSE
...
/datum/chemical_reaction/food/synthmeat
	...
	mob_react = FALSE
	resulting_food_path = /obj/item/reagent_containers/food/snacks/meat/slab/synthmeat

/datum/chemical_reaction/food/synthmeat/synthblood
...
/datum/chemical_reaction/food/imitationcarpmeat
	...
	resulting_food_path = /obj/item/reagent_containers/food/snacks/carpmeat/imitation
	container_transform = TRUE
...
/datum/chemical_reaction/food/cakebatter
	name = "Cake Batter"
	id = "cakebatter"
	required_reagents = list(/datum/reagent/consumable/eggyolk = 5, /datum/reagent/consumable/flour = 15, /datum/reagent/consumable/sugar = 5, /datum/reagent/consumable/eggwhite = 10)
	mix_message = "The ingredients form a cake batter."
	mob_react = FALSE
	resulting_food_path = /obj/item/reagent_containers/food/snacks/cakebatter
...
/datum/chemical_reaction/food/ricebowl
	...
	resulting_food_path = /obj/item/reagent_containers/food/snacks/salad/ricebowl
	container_transform = TRUE
...
/datum/chemical_reaction/food/margarine
	name = "Margarine"
	id = "margarine"
