...
DEFINE_BITFIELD(lighting_flags, list(
	"TURF_HAS_OPAQUE_ATOM" = TURF_HAS_OPAQUE_ATOM,
	"TURF_LIGHTING_CORNERS_INITIALISED" = TURF_LIGHTING_CORNERS_INITIALISED,
))
...
DEFINE_BITFIELD(turf_flags, list(
	"TURF_BULLET_SIZZLE" = TURF_BULLET_SIZZLE,
	"TURF_CHANGING" = TURF_CHANGING,
	"TURF_DIRT_BUILDUP_ALLOWED" = TURF_DIRT_BUILDUP_ALLOWED,
	"TURF_DYNAMIC_LIGHTING" = TURF_DYNAMIC_LIGHTING,
	"TURF_HOLODECK_COMPATIBLE" = TURF_HOLODECK_COMPATIBLE,
	"TURF_INTACT" = TURF_INTACT,
	"TURF_OVERFLOOR_PLACED" = TURF_OVERFLOOR_PLACED,
	"TURF_REQUIRES_ACTIVATION" = TURF_REQUIRES_ACTIVATION,
	"TURF_TILED_DIRT" = TURF_TILED_DIRT,
))
