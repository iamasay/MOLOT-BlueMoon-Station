/datum/component/manual_blinking
	...
	var/list/valid_emotes = list(/datum/emote/sound/human/carbon/blink, /datum/emote/sound/human/carbon/blink_r)
...
/datum/component/manual_blinking/RegisterWithParent()
	...
	RegisterSignal(parent, COMSIG_ORGAN_INSERTED, PROC_REF(check_added_organ))
	RegisterSignal(parent, COMSIG_ORGAN_REMOVED, PROC_REF(check_removed_organ))
