...
/mob/living/simple_animal/hostile/retaliate/poison/terror_spider/reaper
...
/mob/living/simple_animal/hostile/retaliate/poison/terror_spider/reaper/Life(seconds)
	. = ..()
	if(stat != DEAD)
