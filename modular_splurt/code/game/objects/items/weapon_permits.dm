...
/obj/item/clothing/accessory/permit/special/c_02
	...
	permitted_weapons = "Любое неконтробандное оружие, а так же автоматические винтовки, пистолеты и револьверы высокого калибра, не имеющие символики InteQ "
	notes = "Носитель данного разрешения является проверенным ветераном Авангарда имеющим право владеть и открыто переносить указаное в списке вооружение.\n\
