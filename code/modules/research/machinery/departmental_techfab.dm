...
/obj/machinery/rnd/production/techfab/department/engineering
	...
	req_one_access = list(ACCESS_PRODUCTION_ENGINEERING, ACCESS_AWAY_GENERAL, ACCESS_SYNDICATE)
...
/obj/machinery/rnd/production/techfab/department/service
	...
	req_one_access = list(ACCESS_PRODUCTION_SERVICE, ACCESS_AWAY_GENERAL, ACCESS_SYNDICATE)
...
/obj/machinery/rnd/production/techfab/department/medical
	...
	req_one_access = list(ACCESS_PRODUCTION_MEDICAL, ACCESS_AWAY_GENERAL, ACCESS_SYNDICATE)
...
/obj/machinery/rnd/production/techfab/department/cargo
	...
	req_one_access = list(ACCESS_PRODUCTION_CARGO, ACCESS_AWAY_GENERAL, ACCESS_SYNDICATE)
...
/obj/machinery/rnd/production/techfab/department/security
	...
	req_one_access = list(ACCESS_PRODUCTION_SECURITY, ACCESS_AWAY_GENERAL, ACCESS_SYNDICATE)
