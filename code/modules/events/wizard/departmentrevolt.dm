/datum/round_event_control/wizard/deprevolt //stationwide!
	...
	admin_only = TRUE //An order that requires order in a round of chaos was maybe not the best idea. Requiescat in pace departmental uprising August 2014 - March 2015
...
/datum/round_event/wizard/deprevolt/start()
	...
	switch(tidecolor)
		...
		if("white")
			jobs_to_revolt = list("Chief Medical Officer", "Medical Doctor", "Chemist", "Geneticist", "Paramedic", "Psychologist", "Virologist")
		...
		if("whatevercolorrepresentstheservicepeople") //the few, the proud, the technically aligned
			jobs_to_revolt = list("Bartender", "Cook", "Botanist", "Clown", "Mime", "Janitor", "Chaplain", "Bouncer", "Entertainer") // BLUEMOON ADD - bouncer, Entertainer
