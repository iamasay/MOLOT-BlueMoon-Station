...
#define MUTATION_EXTREME_PRINT_CODE SEC_LEVEL_RED
#define MUTATION_USEFUL_PRINT_CODE SEC_LEVEL_AMBER
#define MUTATION_MINOR_PRINT_CODE SEC_LEVEL_BLUE
...
#define HULK_PRINT_CODE         MUTATION_EXTREME_PRINT_CODE
#define THERMAL		            /datum/mutation/human/thermal
#define THERMAL_PRINT_CODE      MUTATION_EXTREME_PRINT_CODE
#define XRAY		            /datum/mutation/human/thermal/x_ray
#define XRAY_PRINT_CODE         MUTATION_EXTREME_PRINT_CODE
#define SPACEMUT	            /datum/mutation/human/space_adaptation
#define SPACEMUT_PRINT_CODE     MUTATION_USEFUL_PRINT_CODE
//#define NOBREATHMUT   	    /datum/mutation/human/no_breathing
#define TK			            /datum/mutation/human/telekinesis
#define TK_PRINT_CODE           MUTATION_USEFUL_PRINT_CODE
...
#define LASEREYES_PRINT_CODE    MUTATION_EXTREME_PRINT_CODE
#define FLASHPROTECT	        /datum/mutation/human/flash_protection
#define FLASHPROTECT_PRINT_CODE MUTATION_MINOR_PRINT_CODE
#define CHAMELEON	            /datum/mutation/human/chameleon
#define CHAMELEON_PRINT_CODE    MUTATION_MINOR_PRINT_CODE
...
#define FIREBREATH_PRINT_CODE   MUTATION_USEFUL_PRINT_CODE
#define VOID		            /datum/mutation/human/void
#define VOID_PRINT_CODE         MUTATION_USEFUL_PRINT_CODE
...
#define ANTENNA_PRINT_CODE      MUTATION_MINOR_PRINT_CODE
#define PARANOIA	            /datum/mutation/human/paranoia
#define MINDREAD	            /datum/mutation/human/mindreader
#define MINDREAD_PRINT_CODE     MUTATION_MINOR_PRINT_CODE
#define INSULATED	            /datum/mutation/human/insulated
#define INSULATED_PRINT_CODE    MUTATION_MINOR_PRINT_CODE
#define SHOCKTOUCH	            /datum/mutation/human/shock
#define SHOCKTOUCH_PRINT_CODE   MUTATION_USEFUL_PRINT_CODE
...
#define CRYOKINESIS_PRINT_CODE  MUTATION_USEFUL_PRINT_CODE
