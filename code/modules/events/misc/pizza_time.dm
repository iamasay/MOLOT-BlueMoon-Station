...
/datum/round_event/pizza_time/announce(fake)
	priority_announce("Ваше начальство довольно вами и выделяет для вас подарочный обед за свой счёт. Слава ПАКТу!", "Центральное Командование", 'sound/misc/pizza_time.ogg')
