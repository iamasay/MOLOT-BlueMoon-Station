...
/obj/item/reagent_containers/food/snacks/egg
	...
	desc = "An egg!"
	icon_state = "egg"
	list_reagents = list(/datum/reagent/consumable/eggyolk = 5, /datum/reagent/consumable/eggwhite = 10)
...
/obj/item/reagent_containers/food/snacks/omelette/attackby(obj/item/W, mob/user, params)
	if(istype(W, /obj/item/kitchen/fork))
		...
		if(F.forkload)
			...
			user.visible_message("[user] takes a piece of omelette with [user.ru_ego()] fork!", \
