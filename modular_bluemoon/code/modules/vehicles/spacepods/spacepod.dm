...
/obj/spacepod
	...
	icon = 'modular_bluemoon/icons/obj/vehicles/spacepods/goon/construction_2x2.dmi'
	icon_state = "pod_1"
	var/icon/overlay_file = 'modular_bluemoon/icons/obj/vehicles/spacepods/2x2.dmi'
	density = 1
	opacity = 0
...
/obj/spacepod/update_icon()
	...
	if(construction_state != SPACEPOD_ARMOR_WELDED)
		...
		if(pod_armor && construction_state >= SPACEPOD_ARMOR_LOOSE)
			var/mutable_appearance/masked_armor = mutable_appearance(icon = 'modular_bluemoon/icons/obj/vehicles/spacepods/goon/construction_2x2.dmi', icon_state = "armor_mask")
