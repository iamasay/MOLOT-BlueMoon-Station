...
/obj/item/clothing/accessory/permit/special/knifes
	...
	desc = "Зачем нужена полоса стали, если ее нельзя носить?"
	permitted_weapons = "Любое холодное оружие, исключая контрабандное."
	notes = "Сотрудник имеет право применять холодное оружие для самозащиты, в рамках КЗ."

/obj/item/clothing/accessory/permit/special/knifes/mail
	desc = "Магазин даже выбил для вас разрешение!"
	notes = "Разрешение получено в рамках рекламной компании с нашим партнером. Сотрудник имеет право применять холодное оружие для самозащиты, в рамках КЗ."
