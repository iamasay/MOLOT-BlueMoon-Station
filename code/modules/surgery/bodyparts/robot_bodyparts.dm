#define ROBOTIC_LIGHT_BRUTE_MSG "искрится"
#define ROBOTIC_MEDIUM_BRUTE_MSG "покрыта множеством вмятин"
#define ROBOTIC_HEAVY_BRUTE_MSG "отваливается"

#define ROBOTIC_LIGHT_BURN_MSG "покрыта сажей"
#define ROBOTIC_MEDIUM_BURN_MSG "обуглена"
#define ROBOTIC_HEAVY_BURN_MSG "расплавлена"
