...
/obj/machinery/artillerycontrol/ui_interact(mob/user)
	...
	var/datum/browser/popup = new(user, "scroll", "Artillery Control")
...
/obj/machinery/artillerycontrol/Topic(href, href_list)
	...
	if(usr.contents.Find(src) || (in_range(src, usr) && isturf(loc)) || hasSiliconAccessInArea(usr))
		priority_announce("Обнаружена стрельба Артиллерийской Блюспейс-Установки. Приготовиться к удару.")
