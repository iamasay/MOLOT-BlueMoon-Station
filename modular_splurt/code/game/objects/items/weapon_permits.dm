...
/obj/item/clothing/accessory/permit/special/bouncer
	...
	permitted_weapons = "Вооружение вторичной категории и специализированного типа, в том числе пистолеты и парализаторы, наручники и их варианты, болы, а также перцовый баллончик"
