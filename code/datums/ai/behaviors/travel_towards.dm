// PORT: tgstation@14140a6355d1 code/datums/ai/basic_mobs/basic_ai_behaviors/travel_towards.dm
...
///Возврат мирного патруля к якорю: доходим до окрестности, дальше бродим сами
/datum/ai_behavior/travel_towards/patrol_return
	required_distance = 2
