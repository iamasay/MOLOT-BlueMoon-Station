/obj/spacepod/prebuilt
	icon = 'modular_bluemoon/icons/obj/vehicles/spacepods/goon/2x2.dmi'
	icon_state = "pod_civ"
...
/obj/spacepod/prebuilt/ship
	name = "корабль"
	desc = "Ох..."
	icon = 'modular_bluemoon/icons/obj/vehicles/spacepods/2x3.dmi'
	icon_state = "ship_civ"
	overlay_file = 'modular_bluemoon/icons/obj/vehicles/spacepods/2x3.dmi'
	bound_x = 64
	bound_y = 96
