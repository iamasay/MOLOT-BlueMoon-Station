...
GLOBAL_LIST_INIT(colored_mutant_parts, list("insect_wings" = "wings_color", "deco_wings" = "wings_color", "insect_fluff" = "insect_fluff_color", "insect_markings" = "insect_markings_color", "horns" = "horns_color"))
